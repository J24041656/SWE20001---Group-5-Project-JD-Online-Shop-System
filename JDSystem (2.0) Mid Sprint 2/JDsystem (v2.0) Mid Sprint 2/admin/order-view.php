    ...
    <div class="container-2">
      ...
      <div class="customer-details">
        ...
        <div class="row">
          ...
          <div class="col-80">
            <input readonly type="text" id="address" name="address" value="<?php echo htmlspecialchars($order['address']) . ', ' . htmlspecialchars($order['city_name']) . ', ' . htmlspecialchars($order['state_name']) . ', ' . htmlspecialchars($order['country_name']) . ', ' . htmlspecialchars($order['postcode']); ?>">
          </div>
        </div>
      </div>
