...
$sql = "SELECT o.id, o.user, o.tracking_no, o.total_price, o.date, o.address, o.postcode, o.city_id, o.state_id, o.country_id, o.status,
          ...
          <tbody>
            ...
            if($result==TRUE)
            {
              ...
              if($count>0)
              {
                ...
                ?>
                <tr><td colspan="8"><div class="error">No Order</div></td></tr>
              <?php }
              $conn->close();
            }
            ?>
