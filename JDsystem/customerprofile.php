        ...
        <div class="form-box">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if(isset($_POST['submit'] )) {
                    ...
                    elseif(mysqli_num_rows($check_city) == 0) 
                    {
                        ...
                        $mql = "UPDATE `customers` SET `firstName`='".$_POST['firstName']."',`lastName`='".$_POST['lastName']."',`email`='".$_POST['email']."',`contact`='".$_POST['contact']."',`password`='".$_POST['password']."',`country_id`='".$_POST['country_id']."',`state_id`='".$_POST['state_id']."',`city_id`='".$_POST['city_id']."',`postcode`='".$_POST['postcode']."',`address`='".$_POST['address']."'";
            ...
            <form id="profileForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
              ...
              <div class="field input">
                ...
                <!-- <div class="field">
                    <label for="country" style="font-family: Verdana;">Country:</label>
                    <input type="text" id="country" name="country" required style="font-family: Verdana;">
                </div>
                <div class="field">
                    <label for="state" style="font-family: Verdana;">State:</label>
                    <input type="text" id="state" name="state" required style="font-family: Verdana;">
                </div> -->
                <!-- chat gpt city code: -->
                <!-- <div class="field">
                    <label for="city" style="font-family: Verdana;">City:</label>
                    <input type="text" id="city" name="city" required style="font-family: Verdana;">
                </div> -->
                ...
                <div class="field submit">
                    ...
                    <!-- Cancel button -->
                    <button type="button" onclick="cancelEdit()" class="btn-1">Cancel</button>
                </div>
            </form>
      ...
      $(document).ready(function(){
        ...
        {   
            ...
            $.ajax({
                url: 'ajax.php',
                method: 'post',
                data: {country_id: id, state_id: <?php echo $r['state_id'] ?>},
                ...
                else
                {
                    ...
                    $.ajax({
                        url: 'ajax.php',
                        method: 'post',
                        data: {state_id: s_id, type:'state', city_id: <?php echo $r['city_id'] ?>},
                        success: function(result)
                        {
                          $("#city").append(result);
                      }
